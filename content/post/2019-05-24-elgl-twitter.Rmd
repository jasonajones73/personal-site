...
tweets %>%
  ...
  arrange(desc(tweets)) %>%
  top_n(100, tweets) %>%
  datatable(colnames = c("Twitter ID", "Tweet Count"))
```
...
tweets %>%
  ...
  arrange(desc(tweets)) %>%
  top_n(100, tweets) %>%
  datatable(colnames = c("Twitter ID", "Retweet Count"))
```
...
tweets %>%
  ...
  arrange(desc(tweets)) %>%
  top_n(100, tweets) %>%
  datatable(colnames = c("Twitter ID", "Reply Count"))
```
...
tweets %>%
  ...
  datatable(colnames = c("Screen Name", "Count Of Thunder Steals"))
```
